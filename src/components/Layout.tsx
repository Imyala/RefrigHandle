...
const tabs = [
  ...
  { to: '/transactions', label: 'Refrigerant Log' },
  { to: '/history', label: 'Change Log' },
        ...
        >
          {tabs.map((t) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center justify-center px-0.5 py-3 text-center text-[11px] font-medium leading-tight tracking-tight transition sm:text-sm ${
                  isActive
